...
} elseif ($_instance->childHasBeenRendered('l551037034-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l551037034-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l551037034-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l551037034-0');
} else {
    $response = \Livewire\Livewire::mount('roles.crear-rol');
    $html = $response->html();
    $_instance->logRenderedChild('l551037034-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php /**PATH /home/hotelroj/public_html/resources/views/livewire/roles/lista-roles.blade.php ENDPATH**/ ?>