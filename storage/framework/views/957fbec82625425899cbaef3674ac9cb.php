<div>
    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"
        data-original-title="Edit" wire:click="$emit('inactivarTarjeta',<?php echo e($tarjeta->id); ?>)">
    ...
    <?php if($tarjeta->motivo != '1'): ?>
        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            wire:click="$emit('convTarjeta',<?php echo e($tarjeta->id); ?>)">
            <span class="btn-inner">
                CONV. A PRINCIPAL
            </span>
        </a>
...
<?php /**PATH C:\xampp\htdocs\miora-project\resources\views/livewire/marketing/editar-tarjeta.blade.php ENDPATH**/ ?>