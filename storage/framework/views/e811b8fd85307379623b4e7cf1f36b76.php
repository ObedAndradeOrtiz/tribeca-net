<div>
    <button class="ml-4 btn btn-primary" wire:click="$set('crear',true)"><span
            style="color: white; font-size: 24px;">Nueva</span></button>
        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-2 text-sm text-gray-600">
                <form>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="">Teléfono de contacto:</label>
...
<?php /**PATH D:\1.DIGIPROJECTS\9.TRIBECA\1.CODE\public_html\resources\views/livewire/area/crear-area.blade.php ENDPATH**/ ?>