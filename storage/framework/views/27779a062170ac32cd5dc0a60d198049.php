<div>
    <a class="btn btn-sm btn-icon btn-success d-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top"
        title="Ver cliente" data-original-title="Ver cliente" wire:click="$set('openArea5',true)">
        ...
        <svg class="icon-15" width="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                fill="currentColor"></path>
        </svg><span class="ms-1" style="font-size: 8px;">VER HISTORIAL</span>
    ...
    <a class="mt-1 btn btn-sm btn-icon btn-primary d-flex align-items-center" data-bs-toggle="tooltip"
        data-bs-placement="top" title="NUEVA CITA" data-original-title="Nueva cita" wire:click="$set('openArea6',true)">
        ...
        <span class="ms-1" style="font-size: 8px;">NUEVA CITA</span>
...
<?php /**PATH C:\xampp\htdocs\miora-project\resources\views/livewire/clientes/editar-cliente.blade.php ENDPATH**/ ?>