...
} elseif ($_instance->childHasBeenRendered('l3706653148-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3706653148-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3706653148-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3706653148-0');
} else {
    $response = \Livewire\Livewire::mount('inmuebles.crear-inmuebles');
    $html = $response->html();
    $_instance->logRenderedChild('l3706653148-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH C:\xampp\htdocs\tribeca-project\resources\views/livewire/inmuebles/lista-inmuebles.blade.php ENDPATH**/ ?>