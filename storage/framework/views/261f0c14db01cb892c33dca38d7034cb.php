<div class="container px-6 py-4">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            ...
            <select class="form-control form-control-lg" wire:model="motivo">
                <option value="compra">CARGAR</option>
                <option value="traspaso">TRASPASO</option>
                <option value="personal">USO INTERNO</option>
                <option value="farmacia">VENTA</option>
            </select>
        </div>
    ...
    <div class="mb-4">
        <input class="form-control mt-1" type="text" wire:model="search" placeholder="Buscar productos...">
    </div>
...
<?php /**PATH /home/hotelroj/public_html/resources/views/livewire/inventario/comprar-secundario.blade.php ENDPATH**/ ?>