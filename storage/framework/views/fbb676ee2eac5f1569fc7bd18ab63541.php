...
} elseif ($_instance->childHasBeenRendered('l3317023488-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3317023488-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3317023488-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3317023488-0');
} else {
    $response = \Livewire\Livewire::mount('tesoreria.egreso-interno');
    $html = $response->html();
    $_instance->logRenderedChild('l3317023488-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH D:\2.TRIBECA\1.WEB\git\resources\views/livewire/tesoreria/egreso.blade.php ENDPATH**/ ?>