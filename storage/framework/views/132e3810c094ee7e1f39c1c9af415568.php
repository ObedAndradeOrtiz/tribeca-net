...
} elseif ($_instance->childHasBeenRendered('l1884411350-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1884411350-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1884411350-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1884411350-0');
} else {
    $response = \Livewire\Livewire::mount('tipos.crear-tipo');
    $html = $response->html();
    $_instance->logRenderedChild('l1884411350-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH C:\xampp\htdocs\tribeca-project\resources\views/livewire/tipos/lista-tipo.blade.php ENDPATH**/ ?>