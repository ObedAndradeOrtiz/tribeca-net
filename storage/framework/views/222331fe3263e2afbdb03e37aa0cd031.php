            ...
            <form>
                ...
                <div class="row">
                    <div class="col-md-2 form-group">
                        ...
                        <select class="mb-3" wire:model="sucursal">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <div>
                            <select class="" wire:model="tipogasto">
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <select class="" wire:model="cartera">
                    ...
                    <?php if($tipogasto == 'SUELDO' || $tipogasto == 'Bono'): ?>
                        <div class="col-md-2 form-group">
                            ...
                            <select class="mb-3 " wire:model="destinario">
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <select class="mb-3 " wire:model="modopago">
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/livewire/tesoreria/egreso.blade.php ENDPATH**/ ?>