                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link <?php if($opcion == 4): ?> active <?php endif; ?>" data-toggle="tab"
                            href="#admin-habitacion" wire:click="setOpcion(4)">Habitaciones
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="px-4 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <label>Búsqueda habitación: </label>
                                            ...
                                            <div class="card"
                                             ...
                                             <?php echo e($habitacion->estado == 'Activo'
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p>Capacidad: <?php echo e($habitacion->capacidad); ?></p>
...
?>
                                                        <?php endif; ?>
                                                        <?php if($habitacion->estado == 'Ocupado'): ?>
                                                        <?php endif; ?>
                                                        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('recepcionista.estados', ['habitacion' => $habitacion])->html();
} elseif ($_instance->childHasBeenRendered($habitacion->id * 10)) {
    $componentId = $_instance->getRenderedChildComponentId($habitacion->id * 10);
    $componentTag = $_instance->getRenderedChildComponentTagName($habitacion->id * 10);
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild($habitacion->id * 10);
} else {
    $response = \Livewire\Livewire::mount('recepcionista.estados', ['habitacion' => $habitacion]);
    $html = $response->html();
    $_instance->logRenderedChild($habitacion->id * 10, $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                    </div>
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/livewire/recepcionista/lista-recepcion.blade.php ENDPATH**/ ?>