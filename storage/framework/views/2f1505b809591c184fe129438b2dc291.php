...
} elseif ($_instance->childHasBeenRendered('l1826707160-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1826707160-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1826707160-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1826707160-0');
} else {
    $response = \Livewire\Livewire::mount('users.crear-user');
    $html = $response->html();
    $_instance->logRenderedChild('l1826707160-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php /**PATH D:\1.DIGIPROJECTS\9.TRIBECA\1.CODE\public_html\resources\views/livewire/users/lista-user.blade.php ENDPATH**/ ?>