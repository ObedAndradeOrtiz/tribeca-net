...
} elseif ($_instance->childHasBeenRendered('l2692499101-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2692499101-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2692499101-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2692499101-0');
} else {
    $response = \Livewire\Livewire::mount('inventario.crear-producto');
    $html = $response->html();
    $_instance->logRenderedChild('l2692499101-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('l2692499101-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2692499101-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2692499101-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2692499101-1');
} else {
    $response = \Livewire\Livewire::mount('inventario.carga-masiva');
    $html = $response->html();
    $_instance->logRenderedChild('l2692499101-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $productoslist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($lista->tituloProducto); ?></td>
...
?>
    ...
    <script>
        document.getElementById('descargarExcel').addEventListener('click', function() {
            ...
            // Creamos la URL usando la variable
            ...
            fetch(url)
                ...
                .then(data => {
                    const tratamientos = data.map(item => ({
                        tituloProducto: item.tituloProducto,
...
<?php /**PATH C:\xampp\htdocs\miora-project\resources\views/livewire/inventario/lista-inventario.blade.php ENDPATH**/ ?>