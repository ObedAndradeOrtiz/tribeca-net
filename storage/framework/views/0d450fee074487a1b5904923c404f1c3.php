...
<html class="no-js">
	...
	<meta name="keywords" content="Situado en el corazón de la ciudad " />
	<meta name="author" content="Andrasoft" />
		   			...
		   			<div class="col-md-12 text-center js-fullheight fh5co-property-brief slider-text">
		   				<div class="fh5co-property-brief-inner">
		   					<div class="fh5co-box">
                             	...
                             	<span class="price">$540,000 <a href="#" class="tag">Disponible</a></span>
	                        </div>
	                        ...
	                        <p><a href="#" class="btn btn-primary">Reservar</a></p>
		   			...
		   			<div class="col-md-12 text-center js-fullheight fh5co-property-brief slider-text">
		   				<div class="fh5co-property-brief-inner">
		   					<div class="fh5co-box">
		   						...
		   						<div class="price-status">
                             	<span class="price">$2,200<span class="per">/Month</span> <a href="#" class="tag">Disponible</a></span>
	                        </div>
	                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	                        <p class="fh5co-property-specification">
                        		<span><strong>3500</strong> Sq Ft</span>  <span><strong>3</strong> Beds</span>  <span><strong>3.5</strong> Baths</span>  <span><strong>2</strong> Garages</span>
		   			...
		   			<div class="col-md-12 text-center js-fullheight fh5co-property-brief slider-text">
		   				<div class="fh5co-property-brief-inner">
		   					<div class="fh5co-box">
		   						...
		   						<div class="price-status">
                             	<span class="price">$1,540,000 <a href="#" class="tag">Disponible</a></span>
	                        </div>
	                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	                        <p class="fh5co-property-specification">
                        		<span><strong>3500</strong> Sq Ft</span>  <span><strong>3</strong> Beds</span>  <span><strong>3.5</strong> Baths</span>  <span><strong>2</strong> Garages</span>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box" data-animate-effect="fadeIn">
					<h2>Situados en el centro de la ciudad</h2>
					<p>Tu hogar lejos de casa, donde cada detalle cuenta.</p>
				</div>
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						<figure>
							<img src="images/8.jpg" alt="Free Website Templates FreeHTML5.co" class="img-responsive">
							<a href="#" class="tag">Disponible</a>
						</figure>
						<div class="fh5co-property-innter">
							<h3><a href="#">Habitación simple</a></h3>
							<div class="price-status">
		                 	<span class="price">Bs. 120 <span class="per">/día</span> </span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							<h3><a href="#">Habitación doble</a></h3>
							<div class="price-status">
		                 	<span class="price">Bs. 150 <span class="per">/día</span> </span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							<h3><a href="#">Habitación matrimonial</a></h3>
							<div class="price-status">
		                 	<span class="price">280<span class="per">/día</span> </span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
	...
	<div class="fh5co-section-with-image">
		...
		<div class="fh5co-box animate-box">
			<h2>Hospitalidad, Seguridad, &amp; Confort </h2>
			<p>Desde el momento en que cruces nuestras puertas, serás recibido con una calidez genuina y un servicio personalizado que busca superar todas tus expectativas.</p>
			<p><a href="/register" class="btn btn-primary btn-outline with-arrow">Registrarme<i class="icon-arrow-right"></i></a></p>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading animate-box" data-animate-effect="fadeIn">
					...
					<p>Creemos que cada huésped merece una experiencia única y personalizada, por eso nos comprometemos a hacer de cada visita un momento memorable.</p>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading white animate-box" data-animate-effect="fadeIn">
					...
					<p>"Nuestra misión es brindarte un refugio de tranquilidad, donde puedas relajarte y renovar tu espíritu, ya sea durante un viaje de negocios, una escapada romántica o unas merecidas vacaciones"</p>
				</div>
				<div class="col-md-4 text-center item-block animate-box" data-animate-effect="fadeIn">
	...
	<div class="fh5co-cta" style="background-image: url(images/slide_4.jpg);">
		...
		<div class="container">
			<div class="col-md-12 text-center animate-box" data-animate-effect="fadeIn">
				<h3>Atendemos todos los días</h3>
				<p><a href="#" class="btn btn-primary btn-outline with-arrow">Regístrate ahora! <i class="icon-arrow-right"></i></a></p>
			</div>
		</div>
	</div>
	...
	<footer id="fh5co-footer" role="contentinfo">
		...
		<div class="container">
			<div class="col-md-3 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
				...
				<p>Bienvenido al SISTEMA, donde la excelencia en el servicio y la atención al detalle se combinan para ofrecer una experiencia única e inolvidable.</p>
				<p><a href="/register" class="btn btn-primary btn-outline with-arrow btn-sm">Registrarme <i class="icon-arrow-right"></i></a></p>
			</div>
			...
			<div class="col-md-12 fh5co-copyright text-center">
				<p>&copy; 2024 Todos los derechos reservados. <span>Desarrollado con  <i class="icon-heart"></i> por <a href="/" target="_blank">Andrasoft</a> </a></span></p>
			</div>
		</div>
	</footer>
	</div>
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/welcome.blade.php ENDPATH**/ ?>