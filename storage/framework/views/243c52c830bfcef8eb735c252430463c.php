<div>
    ...
    <div style="height: 300px;">
        <canvas style="height: 100%; width: 100%;" id="densityCanvasscaa"></canvas>
    </div>
    <script>
        var lunes = {
            label: 'LUNES',
        ...
        var densityCanvas = document.getElementById("densityCanvasscaa");
...
<?php /**PATH C:\xampp\htdocs\miora-project\resources\views/livewire/estadistica/llamadas-semanal-asistidos.blade.php ENDPATH**/ ?>