...
} elseif ($_instance->childHasBeenRendered('l1694502487-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1694502487-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1694502487-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1694502487-0');
} else {
    $response = \Livewire\Livewire::mount('planilla.lista-planilla');
    $html = $response->html();
    $_instance->logRenderedChild('l1694502487-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l1694502487-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1694502487-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1694502487-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1694502487-1');
} else {
    $response = \Livewire\Livewire::mount('tesoreria.subir-csv');
    $html = $response->html();
    $_instance->logRenderedChild('l1694502487-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\miora-project\resources\views/livewire/tesoreria/egreso-interno.blade.php ENDPATH**/ ?>