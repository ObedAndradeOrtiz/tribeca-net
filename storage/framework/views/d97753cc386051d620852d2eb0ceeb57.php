...
} elseif ($_instance->childHasBeenRendered('l1377383125-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1377383125-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1377383125-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1377383125-0');
} else {
    $response = \Livewire\Livewire::mount('inventario.crear-producto');
    $html = $response->html();
    $_instance->logRenderedChild('l1377383125-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('l1377383125-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1377383125-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1377383125-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1377383125-1');
} else {
    $response = \Livewire\Livewire::mount('inventario.carga-masiva');
    $html = $response->html();
    $_instance->logRenderedChild('l1377383125-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php /**PATH /home/hotelroj/public_html/resources/views/livewire/inventario/lista-inventario.blade.php ENDPATH**/ ?>