...
<?php $component->withAttributes(['wire:model' => 'eliminarboton']); ?>
            ...
            <div class="flex flex-row justify-end px-6 py-4 text-right bg-gray-100">
                <button type="submit" style="background-color:red;" class="btn btn-success"
                    wire:click="eliminarPago">SI,
                    ELIMINAR</button>
            </div>
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/livewire/pagos/lista-pagos-productos.blade.php ENDPATH**/ ?>