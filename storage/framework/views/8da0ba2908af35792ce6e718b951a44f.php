...
} elseif ($_instance->childHasBeenRendered('l2334743226-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2334743226-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2334743226-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2334743226-0');
} else {
    $response = \Livewire\Livewire::mount('roles.crear-rol');
    $html = $response->html();
    $_instance->logRenderedChild('l2334743226-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php /**PATH D:\1.DIGIPROJECTS\9.TRIBECA\1.CODE\public_html\resources\views/livewire/roles/lista-roles.blade.php ENDPATH**/ ?>