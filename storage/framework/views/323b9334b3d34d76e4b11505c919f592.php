...
} elseif ($_instance->childHasBeenRendered('l604694130-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l604694130-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l604694130-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l604694130-0');
} else {
    $response = \Livewire\Livewire::mount('tesoreria.egreso-interno');
    $html = $response->html();
    $_instance->logRenderedChild('l604694130-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH D:\2.TRIBECA\1.WEB\TRIBECA NET\resources\views/livewire/tesoreria/egreso.blade.php ENDPATH**/ ?>