...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <label style="color:firebrick"> Habitación requerida</label>
                                <br>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
<?php /**PATH C:\xampp\htdocs\miora-project-1\resources\views/livewire/clientes/crear-cliente.blade.php ENDPATH**/ ?>