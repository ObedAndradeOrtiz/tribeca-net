...
} elseif ($_instance->childHasBeenRendered('l8171632-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l8171632-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l8171632-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l8171632-0');
} else {
    $response = \Livewire\Livewire::mount('inmuebles.crear-inmuebles');
    $html = $response->html();
    $_instance->logRenderedChild('l8171632-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('l8171632-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l8171632-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l8171632-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l8171632-1');
} else {
    $response = \Livewire\Livewire::mount('inventario.carga-masiva-activos');
    $html = $response->html();
    $_instance->logRenderedChild('l8171632-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/livewire/inmuebles/lista-inmuebles.blade.php ENDPATH**/ ?>