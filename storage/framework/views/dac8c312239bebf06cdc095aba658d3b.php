                ...
                <form>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            <label class="form-label" for="">Costo por mes:</label>
                            <input type="number" class="form-control" id="exampleInputDisabled1"
                                wire:model.defer="costo">
                        </div>
                        <div class="form-group col-md-4">
                            <label class="form-label" for="">Metros de capacidad:</label>
                            <input type="number" class="form-control" id="exampleInputDisabled1"
...
<?php /**PATH D:\1.DIGIPROJECTS\9.TRIBECA\1.CODE\public_html\resources\views/livewire/tratamientos/crear-tratamiento.blade.php ENDPATH**/ ?>