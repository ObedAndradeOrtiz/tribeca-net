<div>
    ...
    <h4 class="mt-4 ml-2">INGRESOS MES ACTUAL</h4>
    <div>
        <canvas id="densityCanvapm"></canvas>
    </div>
    <script>
        var semana1 = {
        ...
        var densityCanvas = document.getElementById("densityCanvapm");
...
<?php /**PATH C:\xampp\htdocs\miora-project-1\resources\views/livewire/estadistica/sucursal-mensual.blade.php ENDPATH**/ ?>