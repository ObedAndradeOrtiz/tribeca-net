<div>
    <div class="container d-flex">
        <a class="mt-1 mr-1 btn btn-sm btn-icon btn-success d-flex align-items-center" data-bs-toggle="tooltip"
            data-bs-placement="top" title="VISUALIZAR DEPARTAMENTO"
        ...
        <a class="mt-1 mr-1 btn btn-sm btn-icon d-flex align-items-center" data-bs-toggle="tooltip"
            data-bs-placement="top" title="AGREGAR DEPARTAMENTO" data-original-title="Edit"
...
} elseif ($_instance->childHasBeenRendered('l148778114-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l148778114-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l148778114-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l148778114-0');
} else {
    $response = \Livewire\Livewire::mount('operativos.crear-hospedado', ['idoperativo' =>  $operativo->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l148778114-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
} elseif ($_instance->childHasBeenRendered('l148778114-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l148778114-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l148778114-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l148778114-1');
} else {
    $response = \Livewire\Livewire::mount('operativos.pagos-cliente', ['idoperativo' => $operativo->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l148778114-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH C:\xampp\htdocs\tribeca-project\resources\views/livewire/operativos/editar-operativo.blade.php ENDPATH**/ ?>