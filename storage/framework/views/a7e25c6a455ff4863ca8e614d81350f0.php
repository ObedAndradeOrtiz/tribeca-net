...
} elseif ($_instance->childHasBeenRendered('l2633093523-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2633093523-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2633093523-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2633093523-0');
} else {
    $response = \Livewire\Livewire::mount('tesoreria.egreso-interno');
    $html = $response->html();
    $_instance->logRenderedChild('l2633093523-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH C:\xampp\htdocs\tribeca-project\resources\views/livewire/tesoreria/egreso.blade.php ENDPATH**/ ?>