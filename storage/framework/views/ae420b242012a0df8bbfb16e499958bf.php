            ...
            <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $planillas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <?php echo e($item->semana); ?>

                            </td>
                            <td>
                                <?php echo e($item->trabajadores); ?>

                            </td>
                            <td>
                                <?php echo e($item->pagado); ?>
                            ...
                            <td>
                                <a class="mt-1 btn btn-sm btn-icon btn-warning d-flex align-items-center"
                                    ...
                                    data-original-title="Edit" href="planilla/<?php echo e($item->id); ?>">
...
<?php /**PATH C:\xampp\htdocs\miora-project-1\resources\views/livewire/planilla/lista-planilla.blade.php ENDPATH**/ ?>