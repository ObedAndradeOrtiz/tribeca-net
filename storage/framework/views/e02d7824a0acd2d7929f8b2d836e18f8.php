...
} elseif ($_instance->childHasBeenRendered('l2476408419-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2476408419-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2476408419-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2476408419-0');
} else {
    $response = \Livewire\Livewire::mount('tesoreria.egreso-interno');
    $html = $response->html();
    $_instance->logRenderedChild('l2476408419-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /home/guislain/tribeca.guislaincorp.com/resources/views/livewire/tesoreria/egreso.blade.php ENDPATH**/ ?>