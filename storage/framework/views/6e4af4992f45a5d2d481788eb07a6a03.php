...
} elseif ($_instance->childHasBeenRendered('l2824676496-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2824676496-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2824676496-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2824676496-0');
} else {
    $response = \Livewire\Livewire::mount('clientes.crear-cliente');
    $html = $response->html();
    $_instance->logRenderedChild('l2824676496-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php /**PATH /home/hotelroj/public_html/resources/views/livewire/clientes/lista-clientes.blade.php ENDPATH**/ ?>