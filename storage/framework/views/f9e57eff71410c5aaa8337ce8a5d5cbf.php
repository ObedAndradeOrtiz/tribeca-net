...
} elseif ($_instance->childHasBeenRendered('l2933700650-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2933700650-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2933700650-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2933700650-0');
} else {
    $response = \Livewire\Livewire::mount('pagos.lista-pagos', ['idoperativo' => $operativo->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l2933700650-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l2933700650-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2933700650-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2933700650-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2933700650-1');
} else {
    $response = \Livewire\Livewire::mount('operativos.lista-hospedados', ['idoperativo' => $operativo->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l2933700650-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </td>
...
} elseif ($_instance->childHasBeenRendered('l2933700650-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2933700650-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2933700650-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2933700650-2');
} else {
    $response = \Livewire\Livewire::mount('operativos.informacion-cliente', ['idoperativo' => $operativo->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l2933700650-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </td>
...
<?php /**PATH D:\1.DIGIPROJECTS\9.TRIBECA\1.CODE\public_html\resources\views/livewire/operativos/pagos-cliente.blade.php ENDPATH**/ ?>