...
} elseif ($_instance->childHasBeenRendered('l441306880-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l441306880-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l441306880-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l441306880-0');
} else {
    $response = \Livewire\Livewire::mount('inmuebles.crear-inmuebles');
    $html = $response->html();
    $_instance->logRenderedChild('l441306880-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('l441306880-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l441306880-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l441306880-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l441306880-1');
} else {
    $response = \Livewire\Livewire::mount('inventario.carga-masiva-activos');
    $html = $response->html();
    $_instance->logRenderedChild('l441306880-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php /**PATH /home/hotelroj/public_html/resources/views/livewire/inmuebles/lista-inmuebles.blade.php ENDPATH**/ ?>