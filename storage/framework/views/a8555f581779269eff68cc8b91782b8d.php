...
} elseif ($_instance->childHasBeenRendered('l2360748215-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2360748215-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2360748215-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2360748215-0');
} else {
    $response = \Livewire\Livewire::mount('roles.crear-rol');
    $html = $response->html();
    $_instance->logRenderedChild('l2360748215-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/livewire/roles/lista-roles.blade.php ENDPATH**/ ?>