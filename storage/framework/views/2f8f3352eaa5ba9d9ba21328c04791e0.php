...
} elseif ($_instance->childHasBeenRendered('l3181133247-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3181133247-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3181133247-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3181133247-0');
} else {
    $response = \Livewire\Livewire::mount('inventario.crear-producto');
    $html = $response->html();
    $_instance->logRenderedChild('l3181133247-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('l3181133247-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3181133247-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3181133247-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3181133247-1');
} else {
    $response = \Livewire\Livewire::mount('inventario.carga-masiva');
    $html = $response->html();
    $_instance->logRenderedChild('l3181133247-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/livewire/inventario/lista-inventario.blade.php ENDPATH**/ ?>