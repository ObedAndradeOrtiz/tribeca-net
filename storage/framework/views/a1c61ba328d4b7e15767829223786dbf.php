<div>
    <button class="ml-4 btn btn-primary d-flex" wire:click="$set('crear',true)" style="">
            ...
            <div class="mt-4 text-sm text-gray-600">
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <label class="form-label" for="">Cantidad de personas:</label>
                            <input type="text" class="form-control" id="exampleInputDisabled1"
                                wire:model.defer="cantidadpersona">
                        </div>
                        <div class="col-md-4 form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="date" class="form-control" id="exampleInputdate" wire:model.defer="fechadefin">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label class="form-label" for="">Seleccionar habitación:</label>
                            <input type="text" class="form-control" id="exampleInputDisabled1"
                            ...
                            <?php $__currentLoopData = $tratamientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tratamiento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    <input type="checkbox" wire:model.defer="tratamientosSeleccionados.<?php echo e($tratamiento->id); ?>"
...
<?php /**PATH /home/hotelroj/public_html/resources/views/livewire/clientes/crear-cliente.blade.php ENDPATH**/ ?>