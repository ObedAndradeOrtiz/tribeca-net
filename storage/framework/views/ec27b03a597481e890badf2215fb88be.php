<div>
    ...
    <div class="ml-2 mr-2 input-group search-input">
        ...
        <input type="search" class="form-control" placeholder="Busqueda..." wire:model="busqueda">
    </div>
                ...
                <tbody>
                    <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($total_monto); ?></td>
                            <td><?php echo e($total_inventario); ?></td>
                            <td><?php echo e($total_inventario + $total_monto); ?></td>

                            <td><?php echo e($gastoarea); ?></td>
                            <td><?php echo e($total_monto + $total_inventario - $gastoarea); ?></td>
                    ...
                    <tr class="bg-gray">
                        ...
                        <td style="color: white"><?php echo e($totalsumainv); ?></td>
                        <td style="color: white"><?php echo e($totalsumamonto + $totalsumainv); ?></td>
                        <td style="color: white"><?php echo e($totalgastos); ?></td>
                        <td style="color: white"><?php echo e($totalsumainv + $totalsumamonto - $totalgastos); ?></td>
...
<?php /**PATH C:\xampp\htdocs\miora-project\resources\views/livewire/tesoreria/pago-sucursal.blade.php ENDPATH**/ ?>