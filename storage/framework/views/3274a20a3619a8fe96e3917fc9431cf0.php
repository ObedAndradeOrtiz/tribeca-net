...
} elseif ($_instance->childHasBeenRendered('l225153908-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l225153908-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l225153908-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l225153908-0');
} else {
    $response = \Livewire\Livewire::mount('users.crear-user');
    $html = $response->html();
    $_instance->logRenderedChild('l225153908-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\miora-project-1\resources\views/livewire/users/lista-user.blade.php ENDPATH**/ ?>