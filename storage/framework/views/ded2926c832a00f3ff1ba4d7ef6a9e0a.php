    ...
    <div class="reg-table-card">
        <div class="reg-table-header">
            ...
            <div class="reg-total-box">
                <span><?php echo e($labelTotalIngresos); ?></span>
                <strong>Bs <?php echo e(number_format($totalIngresosFiltrado, 2)); ?></strong>

                <?php if($anio && $mes): ?>
                    <small><?php echo e($this->nombreMes((int) $mes)); ?> <?php echo e($anio); ?></small>
                <?php elseif($anio): ?>
                    <small>Gestión <?php echo e($anio); ?></small>
                <?php else: ?>
            ...
            <table class="reg-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $ingresos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr wire:key="ingreso-<?php echo e($item->id); ?>">
                            <td data-label="Fecha">
                                <div class="date-main">
                            ...
                            <td data-label="Depositante">
                                <div class="person-main">
                                    <?php echo e($item->depositante ?: 'SIN DEPOSITANTE'); ?>

                                </div>
                                <div class="person-sub">
                                    <?php echo e($item->detalle ?: 'Sin detalle registrado'); ?>
                            ...
                            <td data-label="Departamento sugerido">
                                ...
                                <?php if(!empty($item->sugerencias_multiples)): ?>
                                    <div class="suggestion-stack">

                                        <?php $__currentLoopData = $item->sugerencias_multiples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sugerencia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="suggest-box-mini suggest-box-multiple">
                                                ...
                                                <div class="suggest-mini-top">
                                                    ...
                                                    <div class="suggest-mini-info">
                                                        <div class="suggest-mini-title">
                                                            <?php echo e($sugerencia['departamento']); ?>

                                                        </div>

                                                        <div class="suggest-mini-meta">
                                                            <?php echo e($sugerencia['origen'] ?? 'Sugerencia'); ?>

                                                            · <?php echo e($sugerencia['mes'] ?? ''); ?>

                                                            <?php echo e($sugerencia['anio'] ?? ''); ?>

                                                            · Bs <?php echo e(number_format($sugerencia['saldo_real'] ?? 0, 2)); ?>


                                                            <?php if(($sugerencia['tipo_estado'] ?? null) === 'Descuento pronto pago'): ?>
                                                                · Con descuento
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="suggest-mini-actions">
                                                    ...
                                                    <button type="button" class="btn-suggest-mini btn-suggest-review"
                                                        ...
                                                        wire:click="usarSugerenciaDepartamento(<?php echo e($item->id); ?>, <?php echo \Illuminate\Support\Js::from($sugerencia['departamento'])->toHtml() ?>)">
                                                    ...
                                                    <button type="button" class="btn-suggest-mini btn-suggest-pay"
                                                        ...
                                                        wire:click="pagarAutomaticoSugerencia(<?php echo e($item->id); ?>, <?php echo \Illuminate\Support\Js::from($sugerencia['departamento'])->toHtml() ?>)">
                                ...
                                <?php elseif($item->sugerencia_departamento): ?>
                                    <div class="suggest-box-mini">
                                        <div class="suggest-mini-top">
                                            ...
                                            <div class="suggest-mini-info">
                                                <div class="suggest-mini-title">
                                                    <?php echo e($item->sugerencia_departamento['departamento']); ?>

                                                </div>

                                                <div class="suggest-mini-meta">
                                                    <?php echo e($item->sugerencia_departamento['origen']); ?>

                                                    · <?php echo e($item->sugerencia_departamento['confianza']); ?>

                                                    · <?php echo e($item->sugerencia_departamento['cantidad']); ?> vez/veces
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="suggest-mini-actions">
                                            <button type="button" class="btn-suggest-mini btn-suggest-review"
                                                ...
                                                wire:click="usarSugerencia(<?php echo e($item->id); ?>)">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>

                                            <button type="button" class="btn-suggest-mini btn-suggest-pay"
                                                title="Pagar automáticamente"
                                                wire:click="pagarAutomaticoSugerencia(<?php echo e($item->id); ?>)">
                                                <i class="bi bi-check2-circle"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <td data-label="Aplicado" class="text-end">
                                <span class="amount-applied">
                                    Bs <?php echo e(number_format($item->monto_aplicado, 2)); ?>

                                </span>
                            </td>

                            <td data-label="Saldo" class="text-end">
                                <span class="<?php echo e($item->saldo_pendiente > 0 ? 'amount-pending' : 'amount-ok'); ?>">
                            ...
                            <td data-label="Estado">
                                <?php if($item->estado == 'Aplicado completo'): ?>
                                    <span class="status-pill status-ok">Aplicado completo</span>
                                <?php elseif($item->estado == 'Aplicado parcial'): ?>
                                ...
                                <?php elseif($item->estado == 'No identificado'): ?>
                                    <span class="status-pill status-muted">No identificado</span>
                                <?php else: ?>
                                    <span class="status-pill status-muted"><?php echo e($item->estado); ?></span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td data-label="Acción" class="text-end">
                                <div class="income-actions">
                                    ...
                                    <button type="button" class="btn-regularizar-icon" title="Regularizar ingreso"
                                        wire:click="abrirRegularizar(<?php echo e($item->id); ?>)">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    ...
                                    <button type="button" class="btn-ingreso-delete"
                                        ...
                                        wire:click="eliminarIngresoBancario(<?php echo e($item->id); ?>)">
                ...
                <div class="reg-modal-body">
                    ...
                    <div class="report-filter-bar">
                        ...
                        <div class="report-info-box">
                            <span>Criterio</span>
                            <strong><?php echo e($criterioReporteDeudas); ?></strong>
                        </div>

                        <div class="report-total-box">
                            <span>Departamentos</span>
                            <strong><?php echo e($totalDepartamentosDeudores); ?></strong>
                        </div>

                        <div class="report-total-box">
                            <span>Total deuda</span>
                            <strong>Bs <?php echo e(number_format($totalDeudaReporte, 2)); ?></strong>
                        </div>
                    </div>
                    ...
                    <div class="report-table-wrap">
                        <table class="report-table">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $reporteDeudas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fila): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <div class="report-dept">
                                                <?php echo e($fila['departamento']); ?>
                                        ...
                                        <td>
                                            <div class="debt-months-list">
                                                <?php $__currentLoopData = $fila['meses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="debt-month-item">
                                                        <div>
                                                            <strong><?php echo e($mes['mes']); ?></strong>
                                                            <span>
                                                                Expensa Bs
                                                                <?php echo e(number_format($mes['monto_expensa'], 2)); ?>

                                                                · Pagado Bs
                                                                <?php echo e(number_format($mes['monto_pagado'], 2)); ?>

                                                            </span>
                                                        </div>

                                                        <div class="debt-month-balance">
                                                            Bs <?php echo e(number_format($mes['saldo'], 2)); ?>
                                        ...
                                        <td class="text-center">
                                            <span class="count-pill">
                                                <?php echo e($fila['cantidad_meses']); ?>
                                        ...
                                        <td class="text-end">
                                            <strong class="text-danger">
                                                Bs <?php echo e(number_format($fila['total_deuda'], 2)); ?>
                ...
                <div class="reg-modal-body">
                    ...
                    <div class="income-strip">
                        <div class="income-item wide">
                            ...
                            <strong><?php echo e($ingresoDepositante ?: 'SIN DEPOSITANTE'); ?></strong>
                        </div>

                        <div class="income-item">
                            <span>Fecha</span>
                            <strong>
                                <?php echo e(\Carbon\Carbon::parse($ingresoFecha)->format('d/m/Y')); ?>

                                <?php echo e($ingresoHora); ?>
                        ...
                        <div class="income-item">
                            ...
                            <strong><?php echo e($ingresoComprobante); ?></strong>
                        </div>

                        <div class="income-item">
                            <span>Monto recibido</span>
                            <strong>Bs <?php echo e(number_format($ingresoMonto, 2)); ?></strong>
                        </div>

                        <div class="income-item">
                            <span>Aplicado</span>
                            <strong class="text-primary">
                                Bs <?php echo e(number_format($ingresoAplicado, 2)); ?>
                        ...
                        <div class="income-item">
                            <span>Saldo</span>
                            <strong class="<?php echo e($ingresoSaldo > 0 ? 'text-danger' : 'text-success'); ?>">
                                Bs <?php echo e(number_format($ingresoSaldo, 2)); ?>
                        ...
                        <div class="reg-left-panel">
                            ...
                            <div class="section-card">
                                ...
                                <div class="section-body">
                                    <div class="dept-filter-grid">
                                        ...
                                        <div>
                                            ...
                                            <select class="reg-control" wire:model="departamentoSeleccionado"
                                                ...
                                                <?php $__currentLoopData = $this->departamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($dep->nombre); ?>">
                                                        <?php echo e($dep->nombre); ?> - Bs <?php echo e(number_format($dep->costo, 2)); ?>
                                    ...
                                    <?php if($departamentoSeleccionado): ?>
                                        <div class="dept-title">
                                            <span>Estado de cuenta</span>
                                            <strong><?php echo e($departamentoSeleccionado); ?></strong>
                                        </div>

                                        <?php if(count($expensasDepartamento) > 0): ?>
                                            <div class="mini-table-wrap">
                                                <table class="mini-table">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $expensasDepartamento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr wire:key="expensa-<?php echo e($exp['id']); ?>">
                                                                <td>
                                                                    <div class="mini-main">
                                                                        <?php echo e(\Carbon\Carbon::parse($exp['fecha_mes'])->translatedFormat('F Y')); ?>
                                                                ...
                                                                <td class="text-end">
                                                                    <div class="fw-bold">
                                                                        Bs
                                                                        <?php echo e(number_format($exp['monto_expensa'], 2)); ?>

                                                                    </div>

                                                                    <?php if(!empty($exp['aplica_descuento']) && $exp['aplica_descuento'] == 1): ?>
                                                                        <div class="discount-note">
                                                                            Con descuento: Bs
                                                                            <?php echo e(number_format($exp['monto_con_descuento'], 2)); ?>
                                                                ...
                                                                <td class="text-end">
                                                                    <button type="button" class="btn-add-mini"
                                                                        wire:click="agregarLineaExpensa(<?php echo e($exp['id']); ?>)">
                                                                        Agregar
                                                                    </button>
                                                                </td>
                                                            </tr>
                                ...
                                <div class="section-body p-0">
                                    <div class="mini-table-wrap">
                                        <table class="mini-table">
                                            ...
                                            <tbody>
                                                <?php $__empty_1 = true; $__currentLoopData = $lineas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $linea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr wire:key="linea-<?php echo e($index); ?>">
                                                        <td>
                                                            <div class="mini-main">
                                                                <?php echo e($linea['departamento_nombre'] ?? $linea['tipo']); ?>

                                                            </div>

                                                            <?php if(!empty($linea['fecha_mes'])): ?>
                                                                <div class="mini-sub">
                                                                    <?php echo e($exp['estado']); ?>
                                                        ...
                                                        <td>
                                                            <select class="reg-control compact"
                                                                wire:model.defer="lineas.<?php echo e($index); ?>.estado_pago">
                                                        ...
                                                        <td>
                                                            <input type="number" step="0.01"
                                                                ...
                                                                wire:model.defer="lineas.<?php echo e($index); ?>.monto">
                                                        </td>

                                                        <td>
                                                            <input type="text" class="reg-control compact"
                                                                wire:model.defer="lineas.<?php echo e($index); ?>.observacion"
                                                                placeholder="Observación">
                                                        </td>

                                                        <td class="text-end">
                                                            <button type="button" class="btn-remove"
                                                                wire:click="quitarLinea(<?php echo e($index); ?>)">
                                                                Quitar
                                                            </button>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="section-body p-0">
                                    <div class="mini-table-wrap">
                                        <table class="mini-table">
                                            ...
                                            <tbody>
                                                <?php $__empty_1 = true; $__currentLoopData = $this->aplicacionesActuales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr wire:key="app-<?php echo e($app->id); ?>"
                                                        class="<?php echo e($app->estado == 'Anulado' ? 'row-muted' : ''); ?>">
                                                        <td><?php echo e($app->tipo_aplicacion); ?></td>
                                                        <td><?php echo e($app->departamento_nombre ?: '—'); ?></td>
                                                        <td>
                                                            <?php if($app->fecha_inicio_pago): ?>
                                                                <?php echo e(\Carbon\Carbon::parse($app->fecha_inicio_pago)->format('m/Y')); ?>
                                                        ...
                                                        <td class="text-end">
                                                            <strong>Bs <?php echo e(number_format($app->monto, 2)); ?></strong>
                                                        </td>
                                                        <td>
                                                            <?php if($app->estado == 'Anulado'): ?>
                                                                <span class="status-pill status-muted">Anulado</span>
                                                            <?php else: ?>
                                                                <span
                                                                    class="status-pill status-ok"><?php echo e($app->estado); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if(!empty($app->observacion)): ?>
                                                                <div class="obs-pill">
                                                                    <?php echo e($app->observacion); ?>
                                                        ...
                                                        <td class="text-end">
                                                            <?php if($app->estado != 'Anulado'): ?>
                                                                <button type="button" class="btn-remove"
                                                                    wire:click="anularAplicacion(<?php echo e($app->id); ?>)">
                                                                    Anular
                                                                </button>
                                                            <?php endif; ?>
                                                        </td>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php $__errorArgs = ['nuevoComprobante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="span-2">
                            ...
                            <?php $__errorArgs = ['nuevoDepositante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php $__errorArgs = ['nuevoTipoIngreso'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="span-2">
                            ...
                            <?php $__errorArgs = ['nuevoObservacion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($modalResultadoPagoAutomatico): ?>
            ...
            <div class="auto-pay-modal">
                ...
                <div class="auto-pay-header">
                    <div>
                        ...
                        <h4><?php echo e($resultadoPagoAutomatico['departamento'] ?? ''); ?></h4>
                        <p>
                            <?php echo e($resultadoPagoAutomatico['depositante'] ?? ''); ?>

                            ·
                            <?php echo e(!empty($resultadoPagoAutomatico['fecha']) ? \Carbon\Carbon::parse($resultadoPagoAutomatico['fecha'])->format('d/m/Y') : ''); ?>

                            <?php echo e($resultadoPagoAutomatico['hora'] ?? ''); ?>

                            · Comp. <?php echo e($resultadoPagoAutomatico['comprobante'] ?? 'Sin comprobante'); ?>
                ...
                <div class="auto-pay-summary">
                    <div>
                        ...
                        <strong>Bs <?php echo e(number_format($resultadoPagoAutomatico['monto_ingreso'] ?? 0, 2)); ?></strong>
                    </div>

                    <div>
                        <span>Total aplicado</span>
                        <strong class="text-primary">Bs
                            <?php echo e(number_format($resultadoPagoAutomatico['total_aplicado'] ?? 0, 2)); ?></strong>
                    </div>

                    <div>
                        <span>Saldo restante</span>
                        <strong
                            class="<?php echo e(($resultadoPagoAutomatico['saldo_restante'] ?? 0) > 0 ? 'text-danger' : 'text-success'); ?>">
                            Bs <?php echo e(number_format($resultadoPagoAutomatico['saldo_restante'] ?? 0, 2)); ?>
                ...
                <div class="auto-pay-body">
                    ...
                    <?php if(!empty($resultadoPagoAutomatico['detalle'])): ?>
                        <div class="auto-pay-list">
                            <?php $__currentLoopData = $resultadoPagoAutomatico['detalle']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="auto-pay-item">
                                    <div class="auto-pay-month">
                                        <strong><?php echo e($item['mes']); ?> <?php echo e($item['anio']); ?></strong>

                                        <span>
                                            Expensa Bs <?php echo e(number_format($item['monto_expensa'], 2)); ?>

                                            · Objetivo Bs <?php echo e(number_format($item['monto_objetivo'], 2)); ?>

                                        </span>

                                        <?php if($item['tipo_estado'] === 'Descuento pronto pago'): ?>
                                            <small class="discount-ok">
                                                Descuento pronto pago
                                            </small>
                                        <?php elseif($item['estado_expensa'] === 'Parcial'): ?>
                                    ...
                                    <div class="auto-pay-amounts">
                                        <div>
                                            <span>Aplicado</span>
                                            <strong>Bs <?php echo e(number_format($item['monto_aplicado'], 2)); ?></strong>
                                        </div>

                                        <div>
                                            <span>Pagado total</span>
                                            <strong>Bs <?php echo e(number_format($item['nuevo_pagado'], 2)); ?></strong>
                                        </div>

                                        <div>
                                            <span>Saldo mes</span>
                                            <strong
                                                class="<?php echo e($item['nuevo_saldo'] > 0 ? 'text-danger' : 'text-success'); ?>">
                                                Bs <?php echo e(number_format($item['nuevo_saldo'], 2)); ?>
                                    ...
                                    <div class="auto-pay-state">
                                        <span
                                            class="<?php echo e($item['estado_expensa'] === 'Pagado' ? 'state-paid' : 'state-partial'); ?>">
                                            <?php echo e($item['estado_expensa']); ?>
...
<?php /**PATH /home/guislain/tribeca.guislaincorp.com/resources/views/livewire/tesoreria/regularizar-ingresos.blade.php ENDPATH**/ ?>