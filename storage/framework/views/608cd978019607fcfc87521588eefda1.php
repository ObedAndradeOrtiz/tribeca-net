<div>
    <div class="container d-flex">
        <a class="mt-1 mr-1 btn btn-sm btn-icon btn-success d-flex align-items-center" data-bs-toggle="tooltip"
            data-bs-placement="top" title="VISUALIZAR HABITACION"
        ...
        <a class="mt-1 mr-1 btn btn-sm btn-icon d-flex align-items-center" data-bs-toggle="tooltip"
            data-bs-placement="top" title="AGREGAR HABITACION" data-original-title="Edit"
            wire:click="$set('agreagar',true)" style="background-color: rgb(0, 132, 255);">
            <svg style="color:white;" class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('operativos.crear-hospedado', ['idoperativo' =>  $operativo->id])->html();
} elseif ($_instance->childHasBeenRendered('l3100707036-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3100707036-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3100707036-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3100707036-0');
} else {
    $response = \Livewire\Livewire::mount('operativos.crear-hospedado', ['idoperativo' =>  $operativo->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l3100707036-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php $component->withAttributes(['wire:model.defer' => 'editar']); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('operativos.pagos-cliente', ['idoperativo' => $operativo->id])->html();
} elseif ($_instance->childHasBeenRendered('l3100707036-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3100707036-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3100707036-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3100707036-1');
} else {
    $response = \Livewire\Livewire::mount('operativos.pagos-cliente', ['idoperativo' => $operativo->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l3100707036-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php $component->withAttributes(['wire:model.defer' => 'openArea']); ?>
        <div class="px-6 py-4">
            <div class="text-lg font-medium text-gray-900">
                REAGENDAR REGISTRO DE: <?php echo e($operativo->empresa); ?>

            </div>
            <div class="mt-4 text-sm text-gray-600">
                <form>
                    <div class="form-group">
                        <label class="form-label" for="exampleInputdate">Fecha de entrada:</label>
                        <input type="date" class="form-control" id="exampleInputdate" value="2000-01-01"
                            wire:model.defer="mifecha">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="exampleInputdate">Fecha de salida:</label>
                        <input type="date" class="form-control" id="exampleInputdate" value="2000-01-01"
                            wire:model.defer="finmifecha">
                    </div>
                    <div class="form-group">
...
<?php $component->withAttributes(['wire:model' => 'agreagar']); ?>
        <div class="card">
            <div class="card-header">
                <label class="form-label" for="">Selecciona habitación para agregar:</label>

            </div>
            <div class="card-body">
                <div class="">
                    <input type="text" class="form-control" id="exampleInputDisabled1"
                        wire:model="busquedatratamiento" placeholder="Buscar habitación...">
                </div>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <label  style="background-color: green; width:100%; margin-top:1%;"  type="submit" class="btn btn-success"
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/livewire/operativos/editar-operativo.blade.php ENDPATH**/ ?>