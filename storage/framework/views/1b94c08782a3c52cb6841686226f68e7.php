                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="fw-bold text-success mb-0">
                                Bs <?php echo e(number_format($totalIngresos,2)); ?>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="fw-bold text-warning mb-0">
                                Bs <?php echo e(number_format($totalPendientes,2)); ?>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="fw-bold text-danger mb-0">
                                Bs <?php echo e(number_format($totalEgresos,2)); ?>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="fw-bold text-primary mb-0">
                                <?php echo e($mantenimientosPendientes); ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body text-center">
                    <h1 class="fw-bold text-primary"><?php echo e($totalDeptos); ?></h1>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body text-center">
                    <h1 class="fw-bold text-dark"><?php echo e($totalUsuarios); ?></h1>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-row-bordered align-middle">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $ultimosPagos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($p->empresa); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($p->fechainicio)->format('d/m/Y')); ?></td>
                                <td class="fw-bold">
                                    Bs <?php echo e(number_format($p->cantidad,2)); ?>
...
</div><?php /**PATH C:\xampp\htdocs\tribeca\tribeca-project\resources\views/livewire/panel-inicio/ver-panel.blade.php ENDPATH**/ ?>