...
} elseif ($_instance->childHasBeenRendered('l2474637047-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2474637047-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2474637047-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2474637047-0');
} else {
    $response = \Livewire\Livewire::mount('users.crear-user');
    $html = $response->html();
    $_instance->logRenderedChild('l2474637047-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH /home/guislain/tribeca.guislaincorp.com/resources/views/livewire/users/lista-user.blade.php ENDPATH**/ ?>