        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-4 text-sm text-gray-600">
                <form>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="">Numero de ticket de pago:</label>
                        <input type="text" class="form-control" id="exampleInputDisabled1"
...
<?php /**PATH D:\1.DIGIPROJECTS\9.TRIBECA\1.CODE\public_html\resources\views/livewire/area/editar-area.blade.php ENDPATH**/ ?>