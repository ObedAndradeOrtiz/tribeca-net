<div>
    ...
    <div class="mb-2 ml-4">
        <label for="">Se estan mostrando: <?php echo e($total_monto_citasc); ?> pagos.</label>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="mt-1 btn btn-sm btn-icon btn-warning d-flex align-items-center"
                                ...
                                data-original-title="Edit" wire:click="editarpago(<?php echo e($lista->id); ?>)">
                            ...
                            <a class="mt-1 btn btn-sm btn-icon btn-danger d-flex align-items-center"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="ELIMINAR"
                                data-original-title="Edit" wire:click="$emit('eliminarPagoCita',<?php echo e($lista->id); ?>)">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
    ...
    <div class="mb-2 ml-4">
        <label for="">Se estan mostrando: <?php echo e($total_monto_qr_listac); ?> pagos.</label>
    </div>
    <div class="table-responsive">
        <table id="tabla2" class="table table-striped" role="grid" data-bs-toggle="data-table">
            <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="mt-1 btn btn-sm btn-icon btn-danger d-flex align-items-center"
                                ...
                                wire:click="$emit('eliminarPagoCita',<?php echo e($lista->id); ?>)">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                                        d="M16.34 1.99976H7.67C4.28 1.99976 2 4.37976 2 7.91976V16.0898C2 19.6198 4.28 21.9998 7.67 21.9998H16.34C19.73 21.9998 22 19.6198 22 16.0898V7.91976C22 4.37976 19.73 1.99976 16.34 1.99976Z"
...
<?php /**PATH C:\xampp\htdocs\miora-project\resources\views/livewire/registros/reg-pagos.blade.php ENDPATH**/ ?>