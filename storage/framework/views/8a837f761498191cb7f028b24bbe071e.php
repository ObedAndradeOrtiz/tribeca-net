...
<?php $component->withAttributes(['wire:model.defer' => 'crear']); ?>
        <div class="px-6 py-4">
            <div class="text-lg font-medium text-gray-900">
                Registrar cliente en habitación: <?php echo e($habitacion->nombre); ?>
                ...
                <form>
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" value="<?php echo e(Auth::user()->sucursal); ?>" disabled>
                        </div>
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/livewire/clientes/crear-cliente.blade.php ENDPATH**/ ?>