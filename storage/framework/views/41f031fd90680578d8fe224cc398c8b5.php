                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <div class="mb-0 shadow-none card card-transparent d-flex justify-content-center auth-card">
                                <div class="card-body">
                                    <h4 class="text-center logo-title"><img src="<?php echo e(asset('logos/LOGOSINFONDO.png')); ?>"
                                    ...
                                    <h2 class="text-center" style="color:#ff7bac;"><strong> SPA - MIORA</strong></h2>
                                    ...
                                    <form method="POST" action="<?php echo e(route('login')); ?>">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <button type="submit" class="btn"
                                                style="background-color:#52b1e5; color: aliceblue;">Iniciar sesión
                                            </button>
                                        </div>
...
<?php /**PATH C:\xampp\htdocs\miora-project\resources\views/auth/login.blade.php ENDPATH**/ ?>