...
<?php $component->withAttributes(['submit' => 'updatePassword']); ?>
     ...
     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('Manten tu contraseña en un lugar seguro.')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'current_password','value' => ''.e(__('Antigua contraseña')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'current_password','value' => ''.e(__('Antigua contraseña')).'']); ?>
...
<?php endif; ?>
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/profile/update-password-form.blade.php ENDPATH**/ ?>