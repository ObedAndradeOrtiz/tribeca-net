...
<?php $component->withAttributes(['wire:model.defer' => 'crear']); ?>
        ...
        <div class="px-6 py-4">
            ...
            <div class="pb-2 mb-4 text-xl fw-bold text-dark border-bottom">
                🏢 Registrar copropietario - <?php echo e($habitacion->nombre); ?>
            ...
            <form>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control bg-light" value="<?php echo e(Auth::user()->sucursal); ?>"
                            disabled>
                    </div>
...
<?php /**PATH D:\1.DIGIPROJECTS\9.TRIBECA\1.CODE\public_html\resources\views/livewire/clientes/crear-cliente.blade.php ENDPATH**/ ?>