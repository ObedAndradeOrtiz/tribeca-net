...
} elseif ($_instance->childHasBeenRendered('l3310406548-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3310406548-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3310406548-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3310406548-0');
} else {
    $response = \Livewire\Livewire::mount('users.crear-user');
    $html = $response->html();
    $_instance->logRenderedChild('l3310406548-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH D:\2.TRIBECA\1.WEB\git\resources\views/livewire/users/lista-user.blade.php ENDPATH**/ ?>