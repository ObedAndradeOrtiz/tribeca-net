<div>
    ...
    <h4 class="mt-4 ml-2">LLAMADAS REALIZADAS (SEMANAL)</h4>
    <div style="height: 300px;">
        <canvas style="height: 100%; width: 100%;" id="densityCanvassc"></canvas>
    </div>
    <script>
        var lunes = {
            label: 'LUNES',
        ...
        var densityCanvas = document.getElementById("densityCanvassc");
...
<?php /**PATH C:\xampp\htdocs\miora-project\resources\views/livewire/estadistica/llamadas-semanal.blade.php ENDPATH**/ ?>