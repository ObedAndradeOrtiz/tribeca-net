...
} elseif ($_instance->childHasBeenRendered('l899685652-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l899685652-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l899685652-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l899685652-0');
} else {
    $response = \Livewire\Livewire::mount('area.crear-area');
    $html = $response->html();
    $_instance->logRenderedChild('l899685652-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        <br>
...
<?php /**PATH D:\0.APROJECTS\4.HOTEL-ROJAS\1.CODE\public_html\resources\views/livewire/area/list-area.blade.php ENDPATH**/ ?>