                        ...
                        <tbody>
                            @foreach ($roles as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div><a href="javascript:void(0);">{{ $item->rol }}</a></div>
                                    ...
                                    @foreach ($rolesderol as $rol)
                                        @if ($rol->vista != 'CallCenter' && $rol->vista != 'Inventario')
                                    ...
                                    <td>
                                        <a class="mt-1 btn btn-sm btn-icon btn-danger d-flex align-items-center"
                                            ...
                                            wire:click="$emit('borrarRoles',{{ $item->id }})">
