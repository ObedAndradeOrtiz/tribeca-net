        ...
        <div class="row">
            <div id="Smallchat">
                {{-- <div class="Layout Layout-open Layout-expand Layout-right"
                    style="background-color: #061E5C;color: rgb(255, 255, 255);opacity: 5;border-radius: 10px;">
                    @livewire('mensajeria.chat-bot-interno')
                </div> --}}
                <!--===============CHAT ON BUTTON STRART===============-->
                {{-- @livewire('mensajeria.chat-interno-cantidad') --}}
                <div class="chat_on"> <span class="chat_on_icon">
                    <a  style="text-decoration: none; color:white;"
                    href="https://api.whatsapp.com/send?phone=59177035251&text=Hola%20BBC,%20Quisiera%20más%20información." target="_blank"> <img src="assets/images/redes/ws.png" class="testimonial-img-c" alt=""></a>
                    </span>
                </div>
                <!--===============CHAT ON BUTTON END===============-->
            </div>
            <div id="Smallchat">
                ...
                <!--===============CHAT ON BUTTON STRART===============-->
                {{-- @livewire('mensajeria.chat-interno-cantidad') --}}
                <div class="chat_on_insta"> <span class="chat_on_icon_insta">
                    <a  style="text-decoration: none; color:white;"
                    href="https://www.instagram.com/bolivianbusinesscenter" target="_blank"> <img src="assets/images/redes/insta.png" class="testimonial-img-c" alt=""></a>
                    </span>
                </div>
                <!--===============CHAT ON BUTTON END===============-->
            </div>
