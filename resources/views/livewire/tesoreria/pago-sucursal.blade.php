    ...
    <div class="mb-4 row">
        ...
        <div class="col-md-6">
            <div class="shadow-sm card border-bottom border-info">
                <div class="card-body d-flex justify-content-between">
                    <div>
                        <h4 class="text-info fw-bold">{{ number_format($total_si_pagado,2) }} Bs.</h4>
        ...
        <div class="col-md-6">
            <div class="shadow-sm card border-bottom border-danger">
                <div class="card-body d-flex justify-content-between">
                    <div>
                        <h4 class="text-danger fw-bold">{{ number_format($gastosgenerales,2) }} Bs.</h4>
            ...
            <table id="mitabla-ps" class="table align-middle table-hover">
                ...
                <tbody>
                    ...
                    <tr style="background:#0f172a; color:white; font-weight:bold;">
                        ...
                        <td>Bs {{ number_format($totalsumamonto + $totalsumainv,2) }}</td>
                        <td>Bs {{ number_format($totalgastos,2) }}</td>
                        <td>Bs {{ number_format(($totalsumamonto + $totalsumainv) - $totalgastos,2) }}</td>
                    </tr>
