        ...
        <div class="dashboard-kpi-grid" wire:loading.remove wire:target="anio,mes,cargarPanel">
            ...
            <div class="dashboard-kpi danger">
                ...
                <div>
                    ...
                    <small>Total deuda: Bs {{ number_format($totalDeuda, 2) }}</small>
                </div>
            </div>
            ...
            <div class="dashboard-kpi info">
                ...
                <div>
                    ...
                    <strong>{{ $ingresosPendientes }}</strong>
                    <small>Bs {{ number_format($montoIngresosPendientes, 2) }} por revisar</small>
                </div>
            </div>
            ...
            <div class="dashboard-card large">
                <div class="card-head">
                    <div>
                        ...
                        <p>Departamentos con saldo pendiente hasta {{ $this->nombreMes((int) $mes) }}
                            {{ $anio }}.</p>
                    </div>

                    <span class="card-badge danger">
                        {{ count($deudores) }} visibles
                    </span>
                </div>
                        ...
                        <tbody>
                            @forelse ($deudores as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item['primer_mes_deuda'])
                                            {{ \Carbon\Carbon::parse($item['primer_mes_deuda'])->format('m/Y') }}
                                        @else
                                            -
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <span class="priority priority-{{ strtolower($item['prioridad']) }}">
                                            {{ $item['prioridad'] }}
                                        </span>
                                    </td>
                                </tr>
            ...
            <div class="dashboard-side">
                ...
                <div class="dashboard-card">
                    ...
                    <div class="alert-list">
                        @foreach ($anuncios as $item)
                            <div class="admin-alert {{ $item['tipo'] }}">
                ...
                <div class="dashboard-card">
                    ...
                    <div class="verify-list">
                        @forelse ($departamentosVerificar as $item)
                            <div class="verify-item {{ $item['nivel'] }}">
                                <div>
                                    <strong>{{ $item['departamento'] }}</strong>
                                    <span>{{ $item['tipo'] }} · {{ $item['mes'] }}</span>
            ...
            <div class="dashboard-card">
                <div class="card-head">
                    ...
                    <span class="card-badge warning">
                        Bs {{ number_format($montoIngresosPendientes, 2) }}
                    </span>
                </div>

                <div class="pending-income-list">
                    @forelse ($ultimosIngresosPendientes as $item)
                        <div class="pending-income-item">
                            <div>
                                ...
                                <span>
                                    ...
                                    {{ $item['hora'] }}
                                    · Comp. {{ $item['numero_comprobante'] ?: 'Sin comprobante' }}
                                </span>
                            </div>
