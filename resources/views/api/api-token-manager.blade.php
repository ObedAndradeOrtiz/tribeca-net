<div>
    ...
    <!-- Token Value Modal -->
    <x-dialog-modal wire:model.defer="displayingToken">
        <x-slot name="title">
            {{ __('API Token') }}
        </x-slot>
    ...
    <x-dialog-modal wire:model.defer="managingApiTokenPermissions">
        <x-slot name="title">
    ...
    <x-confirmation-modal wire:model.defer="confirmingApiTokenDeletion">
        <x-slot name="title">
            {{ __('Delete API Token') }}
        </x-slot>
